        ...
        <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
            <h3>
                <div class='flex items-center justify-between'>
                    <span class='text-2xl font-bold text-gray-900'>Create Task</span>
            ...
            <div>
                <x-input label="{{__('Due Date')}}" name="due_date" type="text"  wire:model="due_date"
            ...
            <div>
                <x-input label="{{__('Priority')}}" name="priority" type="text" wire:model="priority"
