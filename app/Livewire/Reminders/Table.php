...
class Table extends DataTableComponent
{
    ...
    protected $listeners = [
        'remindersCreated' => '$refresh',
        'remindersUpdated' => '$refresh',
        'remindersDeleted' => '$refresh',
         'confirmed',
        'cancelled',
    ];
    ...
    public function configure(): void
    {
       ...
       public function columns(): array
            ...
            Column::make("Title", "title")->searchable()->sortable(),            Column::make("Description", "description")->searchable()->sortable(),            Column::make("Date", "date")->searchable()->sortable(),            Column::make("Time", "time")->searchable()->sortable(),            Column::make("User Id", "user_id")->searchable()->sortable(),
    ...
    {
        $this->dispatch('openModal',  component: 'reminders.edit', arguments: ['id' => $id]);
    }
    ...
    {
        if ($this->deleteId) {
            $record = Reminder::where('id', $this->deleteId);
            $record->delete();
            $this->dispatch('remindersDeleted');
        }
    }
    ...
    public function approve($id)
    {
        ...
        $this->dispatch('remindersUpdated');
    }
