...
class Table extends DataTableComponent
{
    ...
    protected $listeners = [
        'filesCreated' => '$refresh',
        'filesUpdated' => '$refresh',
        'filesDeleted' => '$refresh',
         'confirmed',
        'cancelled',
    ];
    ...
    public function configure(): void
    {
       ...
       public function columns(): array
            ...
            Column::make("User Id", "user_id")->searchable()->sortable(),            Column::make("Name", "name")->searchable()->sortable(),            Column::make("Path", "path")->searchable()->sortable(),            Column::make("Type", "type")->searchable()->sortable(),
    ...
    {
        $this->dispatch('openModal',  component: 'files.edit', arguments: ['id' => $id]);
    }
    ...
    {
        if ($this->deleteId) {
            $record = File::where('id', $this->deleteId);
            $record->delete();
            $this->dispatch('filesDeleted');
        }
    }
