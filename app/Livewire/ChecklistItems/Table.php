...
class Table extends DataTableComponent
{
    ...
    protected $listeners = [
        'checklistItemsCreated' => '$refresh',
        'checklistItemsUpdated' => '$refresh',
        'checklistItemsDeleted' => '$refresh',
         'confirmed',
        'cancelled',
    ];
    ...
    public function configure(): void
    {
       ...
       public function columns(): array
            ...
            Column::make("Task Id", "task_id")->searchable()->sortable(),            Column::make("Name", "name")->searchable()->sortable(),            Column::make("Completed", "completed")->searchable()->sortable(),
    ...
    {
        $this->dispatch('openModal',  component: 'checklist-items.edit', arguments: ['id' => $id]);
    }
    ...
    {
        if ($this->deleteId) {
            $record = ChecklistItem::where('id', $this->deleteId);
            $record->delete();
            $this->dispatch('checklistItemsDeleted');
        }
    }
    ...
    public function approve($id)
    {
        ...
        $this->dispatch('checklistItemsUpdated');
    }
